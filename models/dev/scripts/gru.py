...
class gru():
    ...
    def fit(self,
        ...
        """
        Trains a generalized recurrent network with optional feature selection.
        ...
        from scripts.nets import GRUNET
    ...
    def predict(self, ahead = 3):
        ...
        # modernize
        X_modern = modernize(self.__X_train__.columns, ahead = ahead)
